...
public class OllamaService {
    ...
    public String gerarQuestoes(Integer numQuestoes) {
        ...
        String prompt = """
                Gere questões inéditas inspiradas no estilo do vestibular da ENEM (Paraná). 
                ...
                - Retorne SOMENTE o JSON, SEM ASPAS TRIPLAS, sem explicações nem texto fora dele, favor não esquecer nenhuma chave, nem virgula para um json perfeito.
                ...
                - Cada questão deve ter apenas uma alternativa correta e as outras devem ser incorretas.
                - O campo "image" deve ficar vazio.
